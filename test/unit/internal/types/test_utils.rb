...
describe Vobiz::Internal::Types::Utils do
  Utils = Vobiz::Internal::Types::Utils

  module TestUtils
    class M < Vobiz::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Vobiz::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Vobiz::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Vobiz::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Vobiz::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Vobiz::Internal::Types::Array[String]
      ModelArray = -> { Vobiz::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Vobiz::Internal::Types::Array[TestUtils::U] }

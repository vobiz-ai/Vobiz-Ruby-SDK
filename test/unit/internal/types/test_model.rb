...
describe Vobiz::Internal::Types::Model do
  ...
  class ExampleModel < Vobiz::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Vobiz::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Vobiz::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Vobiz::Internal::Types::Model

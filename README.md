...
The Vobiz Ruby library provides convenient access to the Vobiz APIs from Ruby.
...
vobiz = Vobiz::Client.new(
    base_url: Vobiz::Environment::PRODUCTION
)
```
...
voice APIs, SIP trunking, and AI voice agents. This is the official Vobiz Ruby SDK,
built and maintained by the Vobiz team.

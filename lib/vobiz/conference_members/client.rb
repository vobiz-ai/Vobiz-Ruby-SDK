    ...
    class Client
      ...
      def mute_member(request_options: {}, **params)
        ...
        request = Vobiz::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "api/v1/Account/#{URI.encode_uri_component(params[:auth_id].to_s)}/Conference/#{URI.encode_uri_component(params[:conference_name].to_s)}/Member/#{URI.encode_uri_component(params[:member_id].to_s)}/Mute/",
      ...
      #
      # @return [untyped]
      def unmute_member(request_options: {}, **params)
        params = Vobiz::Internal::Types::Utils.normalize_keys(params)
        request = Vobiz::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "DELETE",

...
module Vobiz
  module Recordings
    module Types
      class GetRecordingResponse < Internal::Types::Model
        ...
        field :conference_name, -> { Object }, optional: false, nullable: true
        ...
        field :recording_end_ms, -> { Object }, optional: false, nullable: true

        field :recording_format, -> { String }, optional: false, nullable: false

        field :recording_id, -> { String }, optional: false, nullable: false

        field :recording_start_ms, -> { Object }, optional: false, nullable: true

...
module Vobiz
  module RecordCalls
    class Client
      ...
      # @param params [Vobiz::RecordCalls::Types::StartRecordingRequest]
      ...
      #
      # @return [Object]
      def start_recording(request_options: {}, **params)
        params = Vobiz::Internal::Types::Utils.normalize_keys(params)
        request_data = Vobiz::RecordCalls::Types::StartRecordingRequest.new(params).to_h
        ...
        request = Vobiz::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "api/v1/Account/#{URI.encode_uri_component(params[:auth_id].to_s)}/Call/#{URI.encode_uri_component(params[:call_uuid].to_s)}/Record/",
          body: body,
      ...
      #
      # @return [untyped]
      def stop_recording(request_options: {}, **params)
        params = Vobiz::Internal::Types::Utils.normalize_keys(params)
        request = Vobiz::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "DELETE",
